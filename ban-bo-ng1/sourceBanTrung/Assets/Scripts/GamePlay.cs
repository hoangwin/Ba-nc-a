...
//		Debug.Log("STate Bubble Current:" + LevelManager.currentBubble.GetComponent<Bubble>().state);
		...
		case GamePlay.STATE_WAITING_WIN_LOSE:
			...
			if(isWin)
			{
                ...
                {
                    star = 3;
                    GameObject.Find("Star").GetComponent<UI2DSprite>().sprite2D = SpriteStar3;
                }
                else if (LevelManager.countbubbleShoot <= LevelManager.star2)
                {
                    star =2;
                    GameObject.Find("Star").GetComponent<UI2DSprite>().sprite2D = SpriteStar2;
                }
                else
                {
                    star =1;
                    GameObject.Find("Star").GetComponent<UI2DSprite>().sprite2D = SpriteStar1;
                }
                //save thanh string
                //Debug.Log("----------------------");
