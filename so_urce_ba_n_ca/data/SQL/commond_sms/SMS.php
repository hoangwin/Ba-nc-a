<?php include("../ban_ca_an_xu/MySMS.php"); ?>
<?php
	...
	}else if($pieces[1] == "BANCAANXU")
	{
		ban_ca_an_xu_SMS($U,$T,$PHONE,$SERVICE_NUM);
	}else
	{
...
function BauCuaTomCa($U,$T,$PHONE,$SERVICE_NUM)
{
	...
	else if($SERVICE_NUM =="7795")//7795
	{
		$T = 15000;
		$Coin = 500000;
	}
	else //de test 1000//7195
	{
		$T = 1;
		$Coin = 1;
	}
	...
	if (!empty($result))
	{		
			echo "200| [BAU CUA TOM CA]Xin Chuc Mung. Ban vua nap $Coin Coin vao tai khoan '$U' ";
