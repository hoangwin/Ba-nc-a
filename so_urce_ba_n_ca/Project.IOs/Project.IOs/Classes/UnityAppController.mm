...
//banner : ca-app-pub-7342700401302892/1253680166
// full : ca-app-pub-7342700401302892/7300213760
-(void) showAdmob
{    
    bannerView_ = [[GADBannerView alloc] initWithAdSize:kGADAdSizeBanner];//here
    bannerView_.adUnitID = @"ca-app-pub-7342700401302892/1253680166";//admob caogiaqn
...
-(void) showAdmobFullAds
{
    ...
    interstitial_.adUnitID = @"ca-app-pub-7342700401302892/7300213760";
