...
public class AddCoinControl : MonoBehaviour {    
     ...
     public void PanelButtonCARDPress(int i)
    {
     ...
     public void ButtonIAP1()
     {
         PurchaseIAP("1", "1");
     }
     public void ButtonIAP2()
     {
         PurchaseIAP("2", "2");
     }
     public void ButtonIAP3()
     {
         PurchaseIAP("3", "3");
     }
    ...
    public void CheckCoinButtonPress()
...
#elif UNITY_IOS
         string url = string.Format("sms:{0}?body={1}", number, Message);
         IOsStatic.OpenSMS(number, Message);
#endif
     }
     ...
     public static void PurchaseIAP(string number, string Message)
     {
#if UNITY_ANDROID
        using (AndroidJavaClass jc = new AndroidJavaClass("com.mygame.bancaanxuhd.UnityPlayerNativeActivity"))
        {
...
#elif UNITY_WP8
         WP8Statics.PurchaseIAP(Message);
#elif UNITY_IOS
         string url = string.Format("sms:{0}?body={1}", number, Message);
         IOsStatic.OpenSMS(number, Message);
#endif
