...
//banner : ca-app-pub-7342700401302892/1779001769
// full : ca-app-pub-7342700401302892/4732468166
-(void) showAdmob
{    
    bannerView_ = [[GADBannerView alloc] initWithAdSize:kGADAdSizeBanner];//here
    bannerView_.adUnitID = @"ca-app-pub-7342700401302892/1779001769";//admob caogiaqn
...
-(void) showAdmobFullAds
{
    ...
    interstitial_.adUnitID = @"ca-app-pub-7342700401302892/4732468166";
